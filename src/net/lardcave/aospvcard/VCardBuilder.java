                    ...
                    for (String actualPhoneNumber : phoneNumberList) {
                        if (!phoneSet.contains(actualPhoneNumber)) {
                            ...
                            final String formattedPhoneNumber =
                                    net.lardcave.fakecontacts.HiddenForNoGoodReason.PNU_formatNumber(actualPhoneNumber, format);
    ...
    public VCardBuilder appendPhotos(final List<ContentValues> contentValuesList) {
        if (contentValuesList != null) {
            for (ContentValues contentValues : contentValuesList) {
                ...
                final String photoString = new String(Base64.encode(data, Base64.DEFAULT));
