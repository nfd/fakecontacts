 ...
 */
package net.lardcave.aospvcard;
...
public class VCardEntry {
    ...
    private void addPhone(int type, String data, String label, boolean isPrimary) {
        ...
        if (type == Phone.TYPE_PAGER) {
            ...
            formattedNumber = net.lardcave.fakecontacts.HiddenForNoGoodReason.PNU_formatNumber(builder.toString(), formattingType);
        }
    ...
    public Uri pushIntoContentResolver(ContentResolver resolver) {
        ...
        ContentProviderOperation.Builder builder =
            ContentProviderOperation.newInsert(net.lardcave.fakecontacts.FakeContract.RAW_CONTACTS_CONTENT_URI);
        ...
        if (mAccount != null) {
            ...
            if (ACCOUNT_TYPE_GOOGLE.equals(mAccount.type)) {
                final Cursor cursor = resolver.query(net.lardcave.fakecontacts.FakeContract.GROUPS_CONTENT_URI, new String[] {
                        Groups.SOURCE_ID },
        ...
        if (!nameFieldsAreEmpty()) {
            builder = ContentProviderOperation.newInsert(net.lardcave.fakecontacts.FakeContract.DATA_CONTENT_URI);
    ...
    public static VCardEntry buildFromResolver(ContentResolver resolver) {
        return buildFromResolver(resolver, net.lardcave.fakecontacts.FakeContract.CONTACTS_CONTENT_URI);
    }
