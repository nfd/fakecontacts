...
import net.lardcave.aospvcard.exception.VCardException;
...
public class VCardComposer {
     ...
     */
    public static final String VCARD_TEST_AUTHORITY = "net.lardcave.aospvcard.unit_tests.vcard";
    ...
    public boolean init(final String selection, final String[] selectionArgs) {
        return init(net.lardcave.fakecontacts.FakeContract.LEGACY_CONTENT_URI, selection, selectionArgs, null);
    }
    ...
    public boolean init(final Uri contentUri, final String selection,
        ...
        if (net.lardcave.fakecontacts.FakeContract.LEGACY_CONTENT_URI.equals(contentUri) ||
    ...
    private String createOneEntryInternal(final String contactId,
        ...
        try {
            final Uri uri = net.lardcave.fakecontacts.FakeContract.RAW_CONTACT_ENTITIES_CONTENT_URI.buildUpon()
