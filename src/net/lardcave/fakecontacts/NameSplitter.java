...
public class NameSplitter {
    ...
    public static class Name {
        ...
        public void fromValues(ContentValues values) {
            ...
            fullNameStyle = integer == null ? 0 /* FullNameStyle.UNDEFINED */ : integer;
            ...
            integer = values.getAsInteger("data11"); // wzStructuredName
            phoneticNameStyle = integer == null ? 0 /* PhoneticNameStyle.UNDEFINED */ : integer;
        }
        ...
        public void toValues(ContentValues values) {
            ...
            values.put("data10", fullNameStyle);
            ...
            values.put("data11", phoneticNameStyle);// wzStructuredName
        }
        ...
        public void clear() {
            ...
            familyName = null;
            suffix = null;
            fullNameStyle = 0 /* FullNameStyle.UNDEFINED */;
            phoneticFamilyName = null;
            phoneticMiddleName = null;
            phoneticGivenName = null;
            phoneticNameStyle = 0 /* PhoneticNameStyle.UNDEFINED */;
        }
    ...
    public void split(Name name, String fullName) {
        ...
        if (fullNameStyle == 2 /* FullNameStyle.CJK */) {
        ...
        switch (fullNameStyle) {
            case 3 /* FullNameStyle.CHINESE */:
                splitChineseName(name, fullName);
                break;

            case 4 /* FullNameStyle.JAPANESE */:
            case 5 /* FullNameStyle.KOREAN */:
    ...
    public int getAdjustedFullNameStyle(int nameStyle) {
        if (nameStyle == 0 /* FullNameStyle.UNDEFINED */) {
            if (JAPANESE_LANGUAGE.equals(mLanguage)) {
                return 4 /* FullNameStyle.JAPANESE */;
            } else if (KOREAN_LANGUAGE.equals(mLanguage)) {
                return 5 /* FullNameStyle.KOREAN */;
            } else if (CHINESE_LANGUAGE.equals(mLanguage)) {
                return 3 /* FullNameStyle.CHINESE */;
            } else {
                return 1 /* FullNameStyle.WESTERN */;
            }
        } else if (nameStyle == 2 /* FullNameStyle.CJK */) {
            if (JAPANESE_LANGUAGE.equals(mLanguage)) {
                return 4 /* FullNameStyle.JAPANESE */;
            } else if (KOREAN_LANGUAGE.equals(mLanguage)) {
                return 5 /* FullNameStyle.KOREAN */;
    ...
    public int getAdjustedNameStyleBasedOnPhoneticNameStyle(int nameStyle, int phoneticNameStyle) {
        if (phoneticNameStyle != 0 /* PhoneticNameStyle.UNDEFINED */) {
            if (nameStyle == 0 /* FullNameStyle.UNDEFINED */ || nameStyle == 2 /* FullNameStyle.CJK */) {
                if (phoneticNameStyle == 4 /* PhoneticNameStyle.JAPANESE */) {
                    return 4 /* FullNameStyle.JAPANESE */;
                } else if (phoneticNameStyle == 5 /* PhoneticNameStyle.KOREAN */) {
                    return 5 /* FullNameStyle.KOREAN */;
                }
                if (nameStyle == 2 /* FullNameStyle.CJK */ && phoneticNameStyle == 3 /* PhoneticNameStyle.PINYIN */) {
                    return 3 /* FullNameStyle.CHINESE */;
                }
            }
        }
    ...
    private void guessFullNameStyle(NameSplitter.Name name) {
        if (name.fullNameStyle != 0 /* FullNameStyle.UNDEFINED */) {
            return;
        }
        ...
        if (bestGuess != 0 /* FullNameStyle.UNDEFINED */ && bestGuess != 2 /* FullNameStyle.CJK */
                && bestGuess != 1 /* FullNameStyle.WESTERN */) {
            name.fullNameStyle = bestGuess;
            return;
        }

        int guess = guessFullNameStyle(name.familyName);
        if (guess != 0 /* FullNameStyle.UNDEFINED */) {
            if (guess != 2 /* FullNameStyle.CJK */ && guess != 1 /* FullNameStyle.WESTERN */) {
    ...
    public int guessFullNameStyle(String name) {
        if (name == null) {
            return 0 /* FullNameStyle.UNDEFINED */;
        }

        int nameStyle = 0 /* FullNameStyle.UNDEFINED */;
        ...
        while (offset < length) {
            ...
            if (Character.isLetter(codePoint)) {
                ...
                nameStyle = 1 /* FullNameStyle.WESTERN */;
            }
    ...
    private int guessCJKNameStyle(String name, int offset) {
        ...
        return 2 /* FullNameStyle.CJK */;
    }

    private void guessPhoneticNameStyle(NameSplitter.Name name) {
        if (name.phoneticNameStyle != 0 /* PhoneticNameStyle.UNDEFINED */) {
            return;
        }
    ...
    public int guessPhoneticNameStyle(String name) {
        if (name == null) {
            return 0 /* PhoneticNameStyle.UNDEFINED */;
        }

        int nameStyle = 0 /* PhoneticNameStyle.UNDEFINED */;
        int length = name.length();
        int offset = 0;
        while (offset < length) {
            int codePoint = Character.codePointAt(name, offset);
            if (Character.isLetter(codePoint)) {
                UnicodeBlock unicodeBlock = UnicodeBlock.of(codePoint);
                if (isJapanesePhoneticUnicodeBlock(unicodeBlock)) {
                    return 4 /* PhoneticNameStyle.JAPANESE */;
                }
                if (isKoreanUnicodeBlock(unicodeBlock)) {
                    return 5 /* PhoneticNameStyle.KOREAN */;
                }
                if (isLatinUnicodeBlock(unicodeBlock)) {
                    return 3 /* PhoneticNameStyle.PINYIN */;
                }
            }
            offset += Character.charCount(codePoint);
        }
