...
import net.lardcave.fakecontacts.HiddenForNoGoodReason.DisplayNameSources;
import net.lardcave.fakecontacts.HiddenForNoGoodReason.FullNameStyle;
...
// wzdd: all hidden, don't care about this crap
...
*/
    ...
    public interface RawContactsColumns {
        ...
        public static final String CONCRETE_IS_RESTRICTED =
                Tables.RAW_CONTACTS + "." + "is_restricted"; // wzdd: RawContacts.IS_RESTRICTED;

        public static final String DISPLAY_NAME = "display_name"; // wzdd: RawContacts.DISPLAY_NAME_PRIMARY;
        public static final String DISPLAY_NAME_SOURCE = "display_name_source"; // wzdd: RawContacts.DISPLAY_NAME_SOURCE;
        ...
        public static final String CONCRETE_NAME_VERIFIED =
                Tables.RAW_CONTACTS + "." + "name_verified"; // wzdd: RawContacts.NAME_VERIFIED;
    }
    ...
    ContactsDatabaseHelper(Context context) {
        ...
        mContext = context;
        mUseStrictPhoneNumberComparison = false;
// wzdd
...
*/
    ...
    private static void createContactsViews(SQLiteDatabase db) {
        ...
        String dataColumns =
                ...
                + Data.DATA_VERSION + ", "
                + PackagesColumns.PACKAGE + " AS " + "res_package" + ","
                + MimetypesColumns.MIMETYPE + " AS " + "mimetype" + ", "
                + Data.DATA1 + ", "
                + Data.DATA2 + ", "
                + Data.DATA3 + ", "
                + Data.DATA4 + ", "
        ...
        String syncColumns =
                ...
                + RawContactsColumns.CONCRETE_NAME_VERIFIED + " AS " + "name_verified" + ","
        ...
        String contactNameColumns =
                "name_raw_contact." + "display_name_source"
                        + " AS " + "display_name_source" + ", "
                + "name_raw_contact." + "display_name"
                        + " AS " + "display_name" + ", "
                + "name_raw_contact." + "display_name_alt"
                        + " AS " + "display_name_alt" + ", "
                + "name_raw_contact." + "phonetic_name"
                        + " AS " + "phonetic_name" + ", "
                + "name_raw_contact." + "phonetic_name_style"
                        + " AS " + "phonetic_name_style" + ", "
                + "name_raw_contact." + "sort_key"
                        + " AS " + "sort_key" + ", "
                + "name_raw_contact." + "sort_key_alt"
                        + " AS " + "sort_key_alt" + ", "
        ...
        String dataSelect = "SELECT "
                ...
                +   "name_raw_contact_id" + "=name_raw_contact." + RawContacts._ID + ")"
    ...
    private static void createContactEntitiesView(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE VIEW " + Tables.CONTACT_ENTITIES_RESTRICTED + " AS "
                + contactEntitiesSelect + " WHERE " + "is_restricted" + "=0");
    }
...
//            db.execSQL("DROP TABLE IF EXISTS " + Tables.ACTIVITIES + ";");
    ...
    private void upgradeToVersion203(SQLiteDatabase db) {
        ...
        db.execSQL(
                ...
                " ADD " + "name_raw_contact_id" + " INTEGER REFERENCES raw_contacts(_id)");
        db.execSQL(
        ...
        db.execSQL(
                ...
                " SET " + "name_raw_contact_id" + "=(" +
                        ...
                        " ORDER BY " + RawContacts._ID +
                        " LIMIT 1)" +
                " WHERE " + "name_raw_contact_id" + " IS NULL"
        );
    ...
    private void upgradeToVersion205(SQLiteDatabase db) {
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + "display_name_alt" + " TEXT;");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + "phonetic_name" + " TEXT;");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + "phonetic_name_style" + " INTEGER;");
        db.execSQL("ALTER TABLE " + Tables.RAW_CONTACTS
                + " ADD " + "sort_key"
    ...
    private void upgradeOrganizationsToVersion205(SQLiteDatabase db,
        ...
        Cursor cursor = db.query(Organization205Query.TABLE, Organization205Query.COLUMNS,
                DataColumns.MIMETYPE_ID + "=" + mimeType + " AND "
                        + "display_name_source" + "=" + DisplayNameSources.ORGANIZATION,
                null, null, null, null);
        try {
            while (cursor.moveToNext()) {
