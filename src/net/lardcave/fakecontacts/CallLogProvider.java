...
public class CallLogProvider extends ContentProvider {
    ...
    static {
        sURIMatcher.addURI(FakeContract.CALL_LOG_AUTHORITY, "calls", CALLS);
        sURIMatcher.addURI(FakeContract.CALL_LOG_AUTHORITY, "calls/#", CALLS_ID);
        sURIMatcher.addURI(FakeContract.CALL_LOG_AUTHORITY, "calls/filter/*", CALLS_FILTER);
    }
...
*/
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        if (c != null) {
            c.setNotificationUri(getContext().getContentResolver(), FakeContract.CALL_LOG_CONTENT_URI);
        }
        return c;
    }
    ...
    public int update(Uri url, ContentValues values, String selection, String[] selectionArgs) {
        ...
        switch (matchedUriId) {
            ...
            case CALLS_ID:
                where = concatenateWhere(selection, Calls._ID + "="
    ...
    protected void notifyChange() {
        getContext().getContentResolver().notifyChange(FakeContract.CALL_LOG_CONTENT_URI, null,
                false /* wake up sync adapters */);
    }
    
    /**
     * Concatenates two SQL WHERE clauses, handling empty or null values.
     * wzdd: clagged from AOSP DatabaseUtils
     */
