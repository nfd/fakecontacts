...
import net.lardcave.fakecontacts.ContactsDatabaseHelper.NicknameLookupColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.Tables;
import net.lardcave.fakecontacts.CGCMaps;
...
public class CommonNicknameCache  {
    ...
    private HashMap<String, SoftReference<String[]>> mNicknameClusterCache = CGCMaps.newHashMap();
