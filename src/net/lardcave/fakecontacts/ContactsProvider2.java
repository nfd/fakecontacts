...
// wzdd: don't care about syncing
//import com.android.internal.content.SyncStateContentProviderHelper;
import net.lardcave.fakecontacts.ContactLookupKey.LookupKeySegment;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.AggregatedPresenceColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.AggregationExceptionColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.Clauses;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.ContactsColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.ContactsStatusUpdatesColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.DataColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.GroupsColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.MimetypesColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.NameLookupColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.NameLookupType;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.PhoneColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.PhoneLookupColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.PresenceColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.RawContactsColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.SettingsColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.StatusUpdatesColumns;
import net.lardcave.fakecontacts.ContactsDatabaseHelper.Tables;
...
public class ContactsProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    static {
        ...
        matcher.addURI(FakeContract.AUTHORITY, "contacts", CONTACTS);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/#", CONTACTS_ID);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/#/data", CONTACTS_DATA);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/#/suggestions",
                AGGREGATION_SUGGESTIONS);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/#/suggestions/*",
                AGGREGATION_SUGGESTIONS);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/#/photo", CONTACTS_PHOTO);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/filter/*", CONTACTS_FILTER);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/lookup/*", CONTACTS_LOOKUP);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/lookup/*/#", CONTACTS_LOOKUP_ID);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/as_vcard/*", CONTACTS_AS_VCARD);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/as_multi_vcard/*",
                CONTACTS_AS_MULTI_VCARD);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/strequent/", CONTACTS_STREQUENT);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/strequent/filter/*",
                CONTACTS_STREQUENT_FILTER);
        matcher.addURI(FakeContract.AUTHORITY, "contacts/group/*", CONTACTS_GROUP);

        matcher.addURI(FakeContract.AUTHORITY, "raw_contacts", RAW_CONTACTS);
        matcher.addURI(FakeContract.AUTHORITY, "raw_contacts/#", RAW_CONTACTS_ID);
        matcher.addURI(FakeContract.AUTHORITY, "raw_contacts/#/data", RAW_CONTACTS_DATA);
        matcher.addURI(FakeContract.AUTHORITY, "raw_contacts/#/entity", RAW_CONTACT_ENTITY_ID);

        matcher.addURI(FakeContract.AUTHORITY, "raw_contact_entities", RAW_CONTACT_ENTITIES);

        matcher.addURI(FakeContract.AUTHORITY, "data", DATA);
        matcher.addURI(FakeContract.AUTHORITY, "data/#", DATA_ID);
        matcher.addURI(FakeContract.AUTHORITY, "data/phones", PHONES);
        matcher.addURI(FakeContract.AUTHORITY, "data/phones/#", PHONES_ID);
        matcher.addURI(FakeContract.AUTHORITY, "data/phones/filter", PHONES_FILTER);
        matcher.addURI(FakeContract.AUTHORITY, "data/phones/filter/*", PHONES_FILTER);
        matcher.addURI(FakeContract.AUTHORITY, "data/emails", EMAILS);
        matcher.addURI(FakeContract.AUTHORITY, "data/emails/#", EMAILS_ID);
        matcher.addURI(FakeContract.AUTHORITY, "data/emails/lookup/*", EMAILS_LOOKUP);
        matcher.addURI(FakeContract.AUTHORITY, "data/emails/filter", EMAILS_FILTER);
        matcher.addURI(FakeContract.AUTHORITY, "data/emails/filter/*", EMAILS_FILTER);
        matcher.addURI(FakeContract.AUTHORITY, "data/postals", POSTALS);
        matcher.addURI(FakeContract.AUTHORITY, "data/postals/#", POSTALS_ID);

        matcher.addURI(FakeContract.AUTHORITY, "groups", GROUPS);
        matcher.addURI(FakeContract.AUTHORITY, "groups/#", GROUPS_ID);
        matcher.addURI(FakeContract.AUTHORITY, "groups_summary", GROUPS_SUMMARY);

        matcher.addURI(FakeContract.AUTHORITY, "syncstate", SYNCSTATE);
        matcher.addURI(FakeContract.AUTHORITY, "syncstate" + "/#",
                SYNCSTATE_ID);

        matcher.addURI(FakeContract.AUTHORITY, "phone_lookup/*", PHONE_LOOKUP);
        matcher.addURI(FakeContract.AUTHORITY, "aggregation_exceptions",
                AGGREGATION_EXCEPTIONS);
        matcher.addURI(FakeContract.AUTHORITY, "aggregation_exceptions/*",
                AGGREGATION_EXCEPTION_ID);

        matcher.addURI(FakeContract.AUTHORITY, "settings", SETTINGS);

        matcher.addURI(FakeContract.AUTHORITY, "status_updates", STATUS_UPDATES);
        matcher.addURI(FakeContract.AUTHORITY, "status_updates/#", STATUS_UPDATES_ID);

        matcher.addURI(FakeContract.AUTHORITY, SearchManager.SUGGEST_URI_PATH_QUERY,
                SEARCH_SUGGESTIONS);
        matcher.addURI(FakeContract.AUTHORITY, SearchManager.SUGGEST_URI_PATH_QUERY + "/*",
                SEARCH_SUGGESTIONS);
        matcher.addURI(FakeContract.AUTHORITY, SearchManager.SUGGEST_URI_PATH_SHORTCUT + "/*",
                SEARCH_SHORTCUT);

        matcher.addURI(FakeContract.AUTHORITY, "live_folders/contacts",
                LIVE_FOLDERS_CONTACTS);
        matcher.addURI(FakeContract.AUTHORITY, "live_folders/contacts/*",
                LIVE_FOLDERS_CONTACTS_GROUP_NAME);
        matcher.addURI(FakeContract.AUTHORITY, "live_folders/contacts_with_phones",
                LIVE_FOLDERS_CONTACTS_WITH_PHONES);
        matcher.addURI(FakeContract.AUTHORITY, "live_folders/favorites",
                LIVE_FOLDERS_CONTACTS_FAVORITES);

        matcher.addURI(FakeContract.AUTHORITY, "provider_status", PROVIDER_STATUS);
    }
    ...
    static {
        ...
        sContactsProjectionMap.put(Contacts.DISPLAY_NAME, "display_name");
        ...
        sDataProjectionMap.put("display_name_alt",
                "display_name_alt");
    ...
    public class StructuredNameRowHandler extends DataRowHandler {
        ...
        public boolean update(SQLiteDatabase db, ContentValues values, Cursor c,
            ...
            if (values.containsKey(StructuredName.DISPLAY_NAME) ||
                ...
                Integer fullNameStyle = augmented.getAsInteger("data10"); // FULL_NAME_STYLE
                insertNameLookupForStructuredName(rawContactId, dataId, name,
                        fullNameStyle != null
                                ? mNameSplitter.getAdjustedFullNameStyle(fullNameStyle)
                                : 0); // FullNameStyle.UNDEFINED
        ...
        private void fixStructuredNameComponents(ContentValues augmented, ContentValues update) {
            ...
            if (touchedUnstruct && !touchedStruct) {
                ...
                name.fullNameStyle = 0; // FullNameStyle.UNDEFINED;
                ...
                update.put("data10", unadjustedFullNameStyle); // FULL_NAME_STYLE
                update.put("data11", name.phoneticNameStyle);
    ...
    private int mProviderStatus = 0; // ProviderStatus.STATUS_NORMAL;
    ...
    private boolean initialize() {
        ...
        mContactAggregator.setEnabled(DO_AGGREGATE_CONTACTS);
    ...
    protected void verifyLocale() {
        ...
        if (mProviderStatus == 3 /*ProviderStatus.STATUS_CHANGING_LOCALE */) {
            return;
        }
        ...
        setProviderStatus(3 /*ProviderStatus.STATUS_CHANGING_LOCALE */);
    ...
    private void importLegacyContactsAsync() {
        ...
        setProviderStatus(1 /*ProviderStatus.STATUS_UPGRADING*/);
    ...
    private void onLegacyContactImportSuccess() {
        ...
        setProviderStatus(0 /* ProviderStatus.STATUS_NORMAL */);
    ...
    private void onLegacyContactImportFailure() {
        ...
        n.setLatestEventInfo(context,
                ...
                PendingIntent.getActivity(context, 0, new Intent("com.android.contacts.action.LIST_DEFAULT"), 0));
        n.flags |= Notification.FLAG_NO_CLEAR | Notification.FLAG_ONGOING_EVENT;

        nm.notify(LEGACY_IMPORT_FAILED_NOTIFICATION, n);

        setProviderStatus(2 /*ProviderStatus.STATUS_UPGRADE_OUT_OF_MEMORY*/);
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        if (mAccessLatch != null) {
            ...
            if (match == PROVIDER_STATUS && isLegacyContactImportNeeded()) {
                ...
                if (newStatus != null && newStatus == 1 /*ProviderStatus.STATUS_UPGRADING*/) {
                    importLegacyContactsAsync();
                    return 1;
                } else {
                    return 0;
    ...
    protected void notifyChange(boolean syncToNetwork) {
        getContext().getContentResolver().notifyChange(FakeContract.AUTHORITY_URI, null,
                syncToNetwork);
    }

    public static final Uri PROVIDERSTATUS_CONTENT_URI = Uri.withAppendedPath(FakeContract.AUTHORITY_URI, "provider_status");
    protected void setProviderStatus(int status) {
        mProviderStatus = status;
        getContext().getContentResolver().notifyChange(PROVIDERSTATUS_CONTENT_URI,
                null, false);
    }
    ...
    protected Uri insertInTransaction(Uri uri, ContentValues values) {
        ...
        ///Log.v(TAG, "URI matched to" + match);

        switch (match) {
            case SYNCSTATE:
                id = -1; /*mDbHelper.getSyncState().insert(mDb, values);*/
                break;
    ...
    private long insertData(ContentValues values, boolean callerIsSyncAdapter) {
        ...
        final String packageName = mValues.getAsString("res_package");
        if (packageName != null) {
            mValues.put(DataColumns.PACKAGE_ID, mDbHelper.getPackageId(packageName));
        }
        mValues.remove("res_package");
        ...
        Log.v(TAG, "Values in insertData " +  values);
    ...
    public void updateRawContactDisplayName(SQLiteDatabase db, long rawContactId) {
        int bestDisplayNameSource = 0; //DisplayNameSources.UNDEFINED;
        NameSplitter.Name bestName = null;
        String bestDisplayName = null;
        String bestPhoneticName = null;
        int bestPhoneticNameStyle = 0; //PhoneticNameStyle.UNDEFINED;
        ...
        try {
            while (c.moveToNext()) {
                ...
                if (source < bestDisplayNameSource || source == 0 /*DisplayNameSources.UNDEFINED*/) {
                    continue;
                }
                ...
                if (mimeType == mMimeTypeIdStructuredName) {
                    ...
                    if (mCharArrayBuffer.sizeCopied != 0) {
                        ...
                        if (mCharArrayBuffer.sizeCopied != 0) {
                            ...
                            bestPhoneticNameStyle = 0; //PhoneticNameStyle.UNDEFINED;
                        }
                    }
                } else {
        ...
        int displayNameStyle = 0; //FullNameStyle.UNDEFINED;

        if (bestDisplayNameSource == 40 /*DisplayNameSources.STRUCTURED_NAME*/) {
            displayNameStyle = bestName.fullNameStyle;
            if (displayNameStyle == 2 /*FullNameStyle.CJK */
                    || displayNameStyle == 0 /*FullNameStyle.UNDEFINED*/) {
    ...
    private int getDisplayNameSource(int mimeTypeId) {
        if (mimeTypeId == mMimeTypeIdStructuredName) {
            return 40; //DisplayNameSources.STRUCTURED_NAME;
        } else if (mimeTypeId == mMimeTypeIdEmail) {
            return 10; //DisplayNameSources.EMAIL;
        } else if (mimeTypeId == mMimeTypeIdPhone) {
            return 20; //DisplayNameSources.PHONE;
        } else if (mimeTypeId == mMimeTypeIdOrganization) {
            return 30; //DisplayNameSources.ORGANIZATION;
        } else if (mimeTypeId == mMimeTypeIdNickname) {
            return 35; //DisplayNameSources.NICKNAME;
        } else {
            return 0; //DisplayNameSources.UNDEFINED;
        }
    }
    ...
    private int deleteData(String selection, String[] selectionArgs, boolean callerIsSyncAdapter) {
        ...
        Cursor c = query(FakeContract.DATA_CONTENT_URI, DataDeleteQuery.COLUMNS, selection, selectionArgs, null);
        try {
            while(c.moveToNext()) {
                long rawContactId = c.getLong(DataDeleteQuery.RAW_CONTACT_ID);
    ...
    public int deleteData(long dataId, String[] allowedMimeTypes) {
        ...
        // so we don't need to worry about deleting data we don't have permission to read.
        mSelectionArgs1[0] = String.valueOf(dataId);
        Cursor c = query(FakeContract.DATA_CONTENT_URI, DataDeleteQuery.COLUMNS, Data._ID + "=?",
        ...
        try {
            ...
            if (!valid) {
                throw new IllegalArgumentException("Data type mismatch: expected "
                        + CGCLists.newArrayList(allowedMimeTypes));
            }
...
/*                selection = appendAccountToSelection(uri, selection);
            ...
            try {
                while (c.moveToNext()) {
                    ...
                    if(!TextUtils.isEmpty(accountName) && !TextUtils.isEmpty(accountType)) {
                        ...
                        ContentResolver.requestSync(account, FakeContract.AUTHORITY,
                                new Bundle());
                        break;
                    }
                }
    ...
    public void onAccountsUpdated(Account[] accounts) {
        ...
        try {
            ...
            if (!accountsToDelete.isEmpty()) {
                ...
                HashSet<Long> orphanContactIds = CGCSets.newHashSet();
                Cursor cursor = mDb.rawQuery("SELECT " + Contacts._ID +
                        " FROM " + Tables.CONTACTS +
                        " WHERE (" + "name_raw_contact_id" + " NOT NULL AND " +
                        "name_raw_contact_id" + " NOT IN " +
                                        "(SELECT " + RawContacts._ID +
                                        " FROM " + Tables.RAW_CONTACTS + "))" +
    ...
    private Cursor query(final SQLiteDatabase db, SQLiteQueryBuilder qb, String[] projection,
        ...
        final Cursor c = qb.query(db, projection, selection, selectionArgs, groupBy, null,
                sortOrder, limit);
        if (c != null) {
            c.setNotificationUri(getContext().getContentResolver(), FakeContract.AUTHORITY_URI);
        }
        return c;
    }
    ...
    private Cursor queryProviderStatus(Uri uri, String[] projection) {
        ...
        for (int i = 0; i < projection.length; i++) {
            ...
            } else if ("data1".equals(projection[i])) {
    ...
    private Cursor bundleLetterCountExtras(Cursor cursor, final SQLiteDatabase db,
        ...
        HashMap<String, String> projectionMap = CGCMaps.newHashMap();
    ...
    private void setTablesAndProjectionMapForContactsWithSnippet(SQLiteQueryBuilder qb, Uri uri,
        ...
        if (mDbHelper.isInProjection(projection, "snippet_data_id")) {
            sb.append(", " + DataColumns.CONCRETE_ID + " AS "
                    + "snippet_data_id");
        }

        if (mDbHelper.isInProjection(projection, "snippet_data1")) {
            sb.append(", " + Data.DATA1 + " AS " + "snippet_data1");
        }

        if (mDbHelper.isInProjection(projection, "snippet_data2")) {
            sb.append(", " + Data.DATA2 + " AS " + "snippet_data2");
        }

        if (mDbHelper.isInProjection(projection, "snippet_data3")) {
            sb.append(", " + Data.DATA3 + " AS " + "snippet_data3");
        }

        if (mDbHelper.isInProjection(projection, "snippet_data4")) {
            sb.append(", " + Data.DATA4 + " AS " + "snippet_data4");
        }

        if (mDbHelper.isInProjection(projection, "snippet_mimetype")) {
            sb.append(", (" +
    ...
    public String getContactsRestrictionExceptionAsNestedQuery(String contactIdColumn) {
        if (mDbHelper.hasAccessToRestrictedData()) {
            ...
            return "(SELECT " + "is_restricted" + " FROM " + Tables.RAW_CONTACTS
    ...
    private AssetFileDescriptor buildAssetFileDescriptor(ByteArrayOutputStream stream) {
        ...
        try {
            ...
            fd = NoSecurity.AssetFileDescriptor_fromMemoryFile(memoryFile);
        } catch (IOException e) {
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case PHONE_LOOKUP:
                return "vnd.android.cursor.dir/phone_lookup"; //PhoneLookup.CONTENT_TYPE;
            case EMAILS:
    ...
    protected boolean isWritableAccount(String accountType) {
        ...
        try {
            for (SyncAdapterType sync : contentService.getSyncAdapterTypes()) {
                if (FakeContract.AUTHORITY.equals(sync.authority) &&
