...
public class GlobalSearchSupport {
    ...
    private Cursor buildCursorForSearchSuggestionsBasedOnPhoneNumber(String searchClause) {
        ...
        s = r.getString(R.string.dial_number_using, searchClause);
        i = s.indexOf('\n');
        if (i < 0) {
            dialNumber.add(s);
            dialNumber.add("");
        ...
        dialNumber.add(String.valueOf(R.drawable.call_contact));
        ...
        s = r.getString(R.string.create_contact_using, searchClause);
        i = s.indexOf('\n');
        if (i < 0) {
            createContact.add(s);
            createContact.add("");
        ...
        createContact.add(String.valueOf(R.drawable.create_contact));
            ...
            while (c.moveToNext()) {
                ...
                if (!c.isNull(SearchSuggestionQuery.PHOTO_ID)) {
                    suggestion.photoUri = Uri.withAppendedPath(
                            ContentUris.withAppendedId(FakeContract.CONTACTS_CONTENT_URI, contactId),
